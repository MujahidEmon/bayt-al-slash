                    ...
                    <Dialog open={isOpen} onClose={() => setIsOpen(false)} className="relative z-50">
                        <div className="fixed inset-0 flex w-screen items-center justify-center p-4">
                            <DialogPanel className="max-w-lg space-y-6 border bg-white p-12">
                                <DialogTitle className="font-bold text-3xl">Want to Delete?</DialogTitle>
                                <Description>This will permanently delete your room</Description>
                                
                                <div className="flex gap-4">
                                    <button onClick={() => setIsOpen(false)}>Cancel</button>
                                    <button className='rounded-lg text-orange-500 font-semibold' onClick={() => {
